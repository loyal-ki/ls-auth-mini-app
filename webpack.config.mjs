  ...
  return {
    ...
    plugins: [
      ...
      new Repack.plugins.ModuleFederationPlugin({
        name: 'ls_auth_mini_app',
        exposes: {
          './AccountScreen': './src/screens/account/account-screen',
          './LoginScreen': './src/screens/login/login-screen',
          './AuthProvider': './src/providers/auth-provider',
        },
        shared: {
          react: {
